...
export default function Auth() {
    ...
    return (
        <div className="max-w-sm mx-auto mt-24 px-6 relative">
            ...
            {isLoading && (
                <div className="absolute inset-0 -inset-x-6 flex flex-col items-center justify-center gap-3 rounded-lg bg-background/80 backdrop-blur-sm">
